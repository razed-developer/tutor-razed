...
const Admin: React.FC = () => {
  ...
  return <main className="admin-page"><aside className="admin-sidebar"><a className="brand" href="/"><span className="orca">◒</span><span>Tutor Portal</span></a><p>ADMIN</p><nav><button className="active">▦ Resources</button><button onClick={addStudent}>♙ Add student</button><button onClick={addGroup}>♧ Add group</button></nav><a href="/">← Return to site</a></aside>

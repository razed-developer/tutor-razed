...
export default function App(){
 ...
 return <div className="app-shell">
  <header><div className="brand"><div className="brand-mark">ƒ</div><div><strong>Pre-Calculus Lab</strong><span>Functions, relations & transformations</span></div></div><button className="menu-btn" onClick={()=>setMenu(!menu)}>{menu?'×':'☰'}</button></header>
